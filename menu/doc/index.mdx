...
<Playground
  scope={{ Menu, MenuButton, Button, ChevronDownIcon, MenuList, MenuItem }}
  code={`
<Menu>
...
<Playground
  scope={{ Menu, MenuButton, ChevronDownIcon, MenuList, MenuItem, MenuDivider }}
  code={`
<Menu>
  <MenuButton
    px={4}
...
<Playground
  scope={{ Menu, MenuButton, MenuList, MenuItem }}
  code={`
<Menu isLazy>
...
<Playground
  scope={{ Menu, MenuButton, Portal, MenuList, MenuItem }}
  code={`
<Menu>
  <MenuButton>Open menu</MenuButton>
  <Portal>
