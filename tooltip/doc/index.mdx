...
import { HStack, PhoneIcon, SearchIcon, VStack, WrapItem } from '../src/index'
...
<Playground
  scope={{ VStack, HStack, Tooltip, Button }}
  code={`
<VStack spacing={6}>
  <HStack spacing={6}>
...
<Playground
  scope={{ Wrap, WrapItem, Tooltip, Button }}
  code={`
<Wrap spacing={6}>
  <WrapItem>
