...
<Playground
  scope={{ Alert, AlertIcon, AlertTitle, AlertDescription, CloseButton }}
  code={`
<Alert status="error">
  <AlertIcon />
...
<Playground
  scope={{ Alert, AlertIcon, AlertTitle, AlertDescription }}
  code={`
<Alert
  status="success"
  variant="subtle"
...
<Playground
  scope={{ Alert, AlertIcon, Box, AlertTitle, AlertDescription, CloseButton }}
  code={`
<Alert status="success">
  <AlertIcon />
  <Box flex="1">
