...
import { SliderFilledTrack, SliderThumb, SliderTrack } from '../src/index'
...
<Playground
  scope={{ Slider, SliderTrack, SliderFilledTrack, SliderThumb }}
  code={`
...
<Playground
  scope={{ Slider, SliderTrack, Box, SliderFilledTrack, SliderThumb }}
  code={`
