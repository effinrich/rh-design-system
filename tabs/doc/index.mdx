...
<Playground
  scope={{ Tabs, TabList, Tab, TabPanels, TabPanel }}
  code={`
<Tabs>
  <TabList>
    <Tab>One</Tab>
...
<Playground
  scope={{ useColorModeValue, Tabs, TabList, Tab, TabPanels, TabPanel }}
  code={`
function Example() {
...
<Playground
  scope={{ Tabs, TabPanels, TabPanel, Image, TabList, Tab }}
  code={`
<Tabs defaultIndex={1}>
  <TabPanels>
    <TabPanel>
...
<Playground
  scope={{ Box, Tabs, TabList, Tab, TabPanels, TabPanel }}
  code={`
...
<PropsTable
  of="Tabs"
  omit={['isTruncated', 'layerStyle', 'noOfLines', 'textStyle', 'styleConfig']}
/>
