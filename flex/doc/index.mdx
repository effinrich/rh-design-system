...
import { Heading, HStack, Spacer, Square, Text } from '../src/index'
...
<Playground
  scope={{ Flex, Center, Text, Square, Box }}
  code={`
<Flex color="white">
...
<Playground
  scope={{ Box, Text, Flex, Spacer, Grid, HStack }}
  code={`
<Box>
...
<Playground
  scope={{ Flex, Box, Heading, Spacer, Button }}
  code={`
<Flex>
  <Box p="2">
